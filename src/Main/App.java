    ...
    public static void menuContabilidad(){
        ...
        do { 
            ...
            switch (menu_contabilidad_opcion) {
                case 1 -> { 
                    Taller.verBalanceActual(); 
                }
                case 2 -> {
                    Taller.verHistorialTransacciones();
                }
                case 3 -> {
                    Taller.newTransaccion();
                }
                case 4 -> {
                    Taller.describeTransaccion();
                }
                case 5 -> {
                    Taller.changeBalanceActual();
                }
                case 6 -> {
                    Taller.deleteTransaccion();
                }
                case 7 -> {
                    //Transaction.changeDetails();
                    System.out.println("Aun no esta programado");
                }
