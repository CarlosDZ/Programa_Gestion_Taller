...
public class Taller {
    ...
    public static void delTipoTransaccion(){
        ...
        if(id == 0) System.out.println("Este tipo de transaccion no se puede borrar ya que es un tipo creado automaticamente y relacionado con el funcionamiento del programa.");
